  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <img src="/favicon.svg" alt="VRIKAAN" style={{ width: 36, height: 36, borderRadius: 10 }} />
        <div style={{ flex: 1 }}>
          ...
          <div ref={msgsRef} style={{ flex: 1, overflowY: "auto", padding: "12px 14px", display: "flex", flexDirection: "column", gap: 10 }}>
            {messages.map((m, i) => (
              <div key={i} style={{ display: "flex", flexDirection: m.role === "user" ? "row-reverse" : "row", gap: 8, alignItems: "flex-start" }}>
                {/* Avatar */}
                {m.role === "bot" && (
                  <img src="/favicon.svg" alt="VRIKAAN" style={{ width: 28, height: 28, borderRadius: 8, flexShrink: 0 }} />
                )}
                {m.role === "user" && (
            ...
            {typing && (
              <div style={{ display: "flex", gap: 8, alignItems: "flex-start" }}>
                <img src="/favicon.svg" alt="VRIKAAN" style={{ width: 28, height: 28, borderRadius: 8 }} />
