    ...
    <>
      <nav style={{
        ...
        <Link to="/" style={{
          ...
          <svg width="36" height="36" viewBox="0 0 32 32" style={{ display: "block", flexShrink: 0 }} aria-label="VRIKAAN">
            <defs>
              <linearGradient id="nv-eye" x1="0" y1="0" x2="1" y2="1">
                <stop offset="0%" stopColor="#14e3c5"/>
                <stop offset="100%" stopColor="#6366f1"/>
              </linearGradient>
              <filter id="nv-glow" x="-100%" y="-100%" width="300%" height="300%">
            ...
            <g filter="url(#nv-glow)">
              <path d="M 9.5 15.5 L 13.5 14 L 13.7 16.2 L 9.8 17.4 Z" fill="url(#nv-eye)">
                <animate attributeName="opacity" values="0.7;1;0.7" dur="2.4s" repeatCount="indefinite"/>
              </path>
              <path d="M 22.5 15.5 L 18.5 14 L 18.3 16.2 L 22.2 17.4 Z" fill="url(#nv-eye)">
                <animate attributeName="opacity" values="0.7;1;0.7" dur="2.4s" repeatCount="indefinite"/>
              </path>
            </g>
