    ...
    <div style={{ background: T.bg, minHeight: "100vh", color: T.white, fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
      ...
      <div style={{ maxWidth: 800, margin: "0 auto", padding: "120px 24px 80px" }}>
        ...
        {[
          ...
          { title: "7. Your Rights", content: "You have the right to access, correct, or delete your personal data. You may also request data portability or restrict processing of your information. For users in the EU/EEA, we comply fully with GDPR requirements. To exercise these rights, contact privacy@secuvion.com." },
          ...
          { title: "10. Contact Us", content: "If you have questions about this Privacy Policy or our data practices, contact us at privacy@secuvion.com or write to: Secuvion Privacy Team, Maharashtra, India." },
        ].map((s, i) => (
