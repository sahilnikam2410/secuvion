  ...
  return (
    <div style={{ background: T.bg, minHeight: "100vh", color: T.white, fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
      <SEO
        ...
        description="Read the SECUVION Terms of Service. Rules governing your use of our AI-powered cybersecurity platform, subscription plans, acceptable use, and legal terms."
        path="/terms"
      />
      <Navbar />
      <div style={{ maxWidth: 800, margin: "0 auto", padding: "120px 24px 80px" }}>
        ...
        {[
          { title: "1. Acceptance of Terms", content: "By accessing or using Secuvion's platform, website, and services, you agree to be bound by these Terms of Service. If you do not agree with any part of these terms, you may not access or use our services. These terms apply to all visitors, users, and subscribers." },
          { title: "2. Description of Services", content: "Secuvion provides AI-powered cybersecurity services including but not limited to: fraud detection, phishing analysis, email breach scanning, device protection, dark web monitoring, and security education resources. Our services are provided on an 'as-is' and 'as-available' basis." },
          ...
          { title: "6. Intellectual Property", content: "All content, features, and functionality of Secuvion — including software, algorithms, designs, text, and graphics — are owned by Secuvion and protected by international copyright, trademark, and intellectual property laws. You may not reproduce, distribute, or create derivative works without prior written consent." },
          { title: "7. Limitation of Liability", content: "Secuvion shall not be liable for any indirect, incidental, special, consequential, or punitive damages resulting from your use of or inability to use our services. Our total liability shall not exceed the amount paid by you in the 12 months preceding the claim. This includes but is not limited to data breaches occurring despite our protection." },
          { title: "8. Disclaimer of Warranties", content: "While we strive for maximum protection, no cybersecurity solution can guarantee 100% security. Secuvion does not warrant that our services will be uninterrupted, error-free, or capable of preventing all cyber threats. Users should maintain their own security hygiene practices alongside our platform." },
